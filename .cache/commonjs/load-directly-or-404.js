...
function getRedirectUrl(path) {
  const url = new URL(path, window.location.origin); // This should never happen, but check just in case - otherwise, there would
...
function _default(resources, path, replaceOnSuccess = false) {
