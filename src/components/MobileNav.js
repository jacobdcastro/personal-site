  ...
  render() {
    return (
      <div id="mySideNav" className="side-nav">
        <img id="closeButton" src="images/icons/delete-button.svg" href="javascript:void(0)" className="close-button" />
        <a className="side-menu-item" href="index.html"><img className="black-logo" src="images/JacobDCastro-black.png" /></a>
