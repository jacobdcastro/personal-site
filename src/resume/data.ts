...
export const RESUME_DATA: ResumeData = {
  ...
  summary: [
    "Senior Full Stack Engineer shipping web products since 2020, most recently in TypeScript, React, Node, GraphQL, and some Rust. High-agency founder and founding-engineer background, with a product engineer's habits: 'writing code and talking to users,' driving features from idea to production, without losing sight of the business goals behind them.",
  ],
  skills: [
    {
      label: "Programming",
